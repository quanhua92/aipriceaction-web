...
import { GLOBAL_WATCHLIST_NAME } from "@/lib/constants";
		...
		<div className="space-y-8">
			...
			<div className="p-4 md:p-6">
				<div className="grid grid-cols-1 md:grid-cols-2 2xl:grid-cols-5 gap-4">
					<TradingViewChart initialTicker="^GSPC" />
					<TradingViewChart initialTicker="^DJI" />
					<TradingViewChart initialTicker="^NDX" />
					<TradingViewChart initialTicker="GC=F" />
					<TradingViewChart initialTicker="CL=F" />
				</div>
			</div>
			...
			<div className="p-2 md:p-6 border-t">
				<MarketMatrix defaultWatchlist={GLOBAL_WATCHLIST_NAME} />
			</div>
