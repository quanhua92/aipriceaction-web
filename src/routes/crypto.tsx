...
import { CRYPTO_WATCHLIST_NAME, CRYPTO_CHART_TICKERS_STORAGE_KEY, LANDING_CHART_TICKERS_COUNT } from "@/lib/constants";
...
const DEFAULT_CRYPTO_TICKERS = ['BTCUSDT', 'ETHUSDT', 'XRPUSDT', 'TONUSDT', 'SOLUSDT', 'DOGEUSDT', 'ADAUSDT', 'AVAXUSDT'] as const;
