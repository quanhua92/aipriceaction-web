export default {
  ...
  rrg: {
    ...
    help: {
      title: 'Hướng Dẫn RRG',
      description: 'Biểu đồ RRG vẽ mỗi mã cổ phiếu thành 1 chấm trên trục X (trục ngang) và Y (trục dọc). Có 4 góc: Dẫn Đầu, Cải Thiện, Yếu Đi, Lạc Hậu.',
      leading: 'Dẫn Đầu (phải-trên):\n• MA Score: giá > MA20 và giá > MA100\n• JdK: RS Ratio >= 100 và RS Momentum >= 100\n→ Mã đang mạnh và ngày càng mạnh hơn.',
      improving: 'Cải Thiện (trái-trên):\n• MA Score: giá < MA20 nhưng giá > MA100\n• JdK: RS Ratio < 100 nhưng RS Momentum >= 100\n→ Mã đang yếu nhưng bắt đầu phục hồi.',
      weakening: 'Yếu Đi (phải-dưới):\n• MA Score: giá > MA20 nhưng giá < MA100\n• JdK: RS Ratio >= 100 nhưng RS Momentum < 100\n→ Mã vẫn mạnh nhưng đang mất đà.',
      lagging: 'Lạc Hậu (trái-dưới):\n• MA Score: giá < MA20 và giá < MA100\n• JdK: RS Ratio < 100 và RS Momentum < 100\n→ Mã yếu và tiếp tục suy yếu.',
      mascoreMode: 'MA Score: Trục X = khoảng cách giá so với MA20 (%). Trục Y = khoảng cách giá so với MA100 (%). Tâm (0, 0) = giá đang nằm đúng trên đường MA.',
      jdkMode: 'JdK RS-Ratio: Trục X = RS Ratio (so với chỉ số tham chiếu). Trục Y = RS Momentum (tốc độ thay đổi RS). Tâm (100, 100) = ngang bằng chỉ số.',
    },
  },
}
