export default {
    ...
    description: {
      ...
      features: {
        ...
        interactiveControls: {
          ...
          description: 'Sử dụng nút bấm, thanh trượt hoặc nhảy nhanh để khám phá dữ liệu'
        },
        manualSelection: {
  ...
  rrg: {
    ...
    help: {
      title: 'Hướng Dẫn RRG',
      description: 'Biểu đồ Xoay Tương Đối vẽ các mã trong biểu đồ 2D. Chế độ JdK dùng RS Ratio và RS Momentum so với chỉ số tham chiếu. Chế độ MA Score dùng MA20 Score và MA100 Score.',
      leading: 'Dẫn Đầu (phải-trên): Trục X và Y đều trên ngưỡng. JdK: vượt trội so với chỉ số và tăng tốc. MA Score: trên cả MA20 và MA100.',
      improving: 'Cải Thiện (trái-trên): Dưới ngưỡng X nhưng trên ngưỡng Y. JdK: kém hơn nhưng đang phục hồi. MA Score: dưới MA20 nhưng trên MA100.',
      weakening: 'Yếu Đi (phải-dưới): Trên ngưỡng X nhưng dưới ngưỡng Y. JdK: vượt trội nhưng đang yếu đi. MA Score: trên MA20 nhưng dưới MA100.',
      lagging: 'Lạc Hậu (trái-dưới): Dưới ngưỡng cả hai trục. JdK: kém hơn và suy yếu thêm. MA Score: dưới cả MA20 và MA100.',
      mascoreMode: 'MA Score: Vẽ MA20 Score (trục x, khoảng cách từ MA20) và MA100 Score (trục y, khoảng cách từ MA100). Tâm tại 0 nghĩa là giá tại đường MA.',
      jdkMode: 'JdK RS-Ratio: Phương pháp JdK chuẩn sử dụng tỷ lệ so với chỉ số tham chiếu với chuẩn hóa Z-score. Tâm tại 100 biểu diễn mức tham chiếu.',
    },
  },
}
