export default {
  ...
  rrg: {
    ...
    help: {
      title: 'RRG Guide',
      description: 'RRG plots each ticker as a dot on X-axis (horizontal) and Y-axis (vertical). There are 4 quadrants: Leading, Improving, Weakening, and Lagging.',
      leading: 'Leading (top-right):\n• MA Score: price > MA20 and price > MA100\n• JdK: RS Ratio >= 100 and RS Momentum >= 100\n→ Strong and accelerating.',
      improving: 'Improving (top-left):\n• MA Score: price < MA20 but price > MA100\n• JdK: RS Ratio < 100 but RS Momentum >= 100\n→ Weak but starting to recover.',
      weakening: 'Weakening (bottom-right):\n• MA Score: price > MA20 but price < MA100\n• JdK: RS Ratio >= 100 but RS Momentum < 100\n→ Still strong but losing momentum.',
      lagging: 'Lagging (bottom-left):\n• MA Score: price < MA20 and price < MA100\n• JdK: RS Ratio < 100 and RS Momentum < 100\n→ Weak and continuing to deteriorate.',
      mascoreMode: 'MA Score: X-axis = distance from MA20 (%). Y-axis = distance from MA100 (%). Center (0, 0) = price is exactly at the moving average.',
      jdkMode: 'JdK RS-Ratio: X-axis = RS Ratio (vs benchmark). Y-axis = RS Momentum (rate of change). Center (100, 100) = performing at benchmark level.',
    },
  },
}
