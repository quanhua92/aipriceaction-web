export default {
  ...
  volumeProfile: {
    ...
    showingDailySummary: 'Showing daily trading summary instead. Intraday volume breakdown is not available for this date.',
    noDataAvailable: 'No trading data available',
    noDataDescription: 'No trading data found for the selected period. Please try a different date or date range.',
    dailyOpen: 'Open',
    dailyHigh: 'High',
    dailyLow: 'Low',
    dailyClose: 'Close',
  ...
  notes: {
    title: 'Notes',
    description: 'Manage your markdown notes. Create, view, and delete notes stored locally.',
    export: 'Export',
    import: 'Import',
    ...
    editorDescription: 'Write or paste your markdown content below. Click Publish to upload and save.',
    editorPlaceholder: '# My Note\n\nStart writing your markdown here...',
    deleteConfirm: 'Delete this note? This will permanently delete the session from the server.',
    deleteSessionConfirm: 'Delete session {id}...? This will permanently delete from server.',
    exported: 'Exported {count} notes',
    imported: 'Imported {count} notes ({newCount} new, {overwrittenCount} overwritten)',
  ...
  rrg: {
    ...
    help: {
      title: 'RRG Guide',
      description: 'Relative Rotation Graph plots tickers in a 2D quadrant chart. JdK mode uses RS Ratio vs RS Momentum relative to a benchmark. MA Score mode uses MA20 Score vs MA100 Score.',
      leading: 'Leading (top-right): Strong X-axis and Y-axis values. For JdK: outperforming benchmark with accelerating strength. For MA Score: above both MA20 and MA100.',
      improving: 'Improving (top-left): Below threshold on X but above on Y. For JdK: underperforming but recovering. For MA Score: below MA20 but above MA100.',
      weakening: 'Weakening (bottom-right): Above threshold on X but below on Y. For JdK: outperforming but losing steam. For MA Score: above MA20 but below MA100.',
      lagging: 'Lagging (bottom-left): Below threshold on both axes. For JdK: underperforming and deteriorating. For MA Score: below both MA20 and MA100.',
      mascoreMode: 'MA Score: Plots MA20 Score (x-axis, distance from 20-day MA) vs MA100 Score (y-axis, distance from 100-day MA). Center at 0 means price is at the moving average.',
      jdkMode: 'JdK RS-Ratio: Standard JdK method using ratio vs benchmark with Z-score normalization. Center at 100 represents benchmark performance.',
    },
  },
}
