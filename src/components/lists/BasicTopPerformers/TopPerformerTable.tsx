          ...
          <Table>
            <TableHeader>
              <TableRow className="bg-muted/30">
                ...
                <TableHead className="text-center min-w-20">{t('common.topPerformers.tableHeaders.volumeChange')}</TableHead>
            ...
            <TableBody>
              {performers.map((performer) => {
                ...
                const isVolumePositive = performer.volumeChanged != null && performer.volumeChanged >= 0
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell className={`text-center font-medium min-w-20 ${
                    ...
                    <TableCell className={`text-center min-w-20 ${
                      ...
                      {performer.volumeChanged != null ? formatPercent(performer.volumeChanged) : '-'}
                    </TableCell>
                    <TableCell className={`text-center min-w-16 ${
                      performer.ma10_score != null && performer.ma10_score >= 0 ? 'text-green-700' : 'text-red-700'
                    }`}>
                      {performer.ma10_score != null ? `${performer.ma10_score.toFixed(1)}%` : '-'}
                    </TableCell>
                    <TableCell className={`text-center min-w-16 ${
                      performer.ma20_score != null && performer.ma20_score >= 0 ? 'text-green-700' : 'text-red-700'
                    }`}>
                      {performer.ma20_score != null ? `${performer.ma20_score.toFixed(1)}%` : '-'}
                    </TableCell>
                    <TableCell className={`text-center min-w-16 ${
